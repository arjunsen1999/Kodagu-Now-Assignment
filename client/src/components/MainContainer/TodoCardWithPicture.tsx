import { TodoCardWithPicturesTypes } from "@/Types/TodoCardWithPictureTypes";
import { Avatar, Box, Flex, Image, Text } from "@chakra-ui/react";
import React from "react";

const TodoCardWithPicture = ({
  picture,
  taskName,
  title,
}: TodoCardWithPicturesTypes) => {
  return (
    <>
      <Flex
      ...
      >
        ...
        <Flex flexDirection={"column"} gap={2} padding={4} width={"100%"}>
          <Flex
            width={"100%"}
...
export default TodoCardWithPicture;
