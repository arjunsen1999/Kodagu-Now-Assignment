import { TodoNavbarProps } from "@/Types/TodoNavbarLinkTypes";
import { Box, Flex, Text } from "@chakra-ui/react";
import React from "react";

const TodoNavbarLinks = ({ name, leftBorderColor }: TodoNavbarProps) => {
  return (
    <>
      <Box
        paddingBlock={3}
      ...
      >
        ...
        >
          <Flex gap={2} justifyContent={"center"} alignItems={"center"}>
            <Text color={"#4D5E80"} fontSize={"12px"} fontWeight={900}>
              {name}
            </Text>
            <Flex
              ...
              boxShadow={"0px 2px 5px 0px rgba(38, 51, 77, 0.03)"}
            >
              <Text color={"#4D5E80"} fontSize={"10px"} fontWeight={900}>
                5
              </Text>
            </Flex>
          </Flex>
...
export default TodoNavbarLinks;
